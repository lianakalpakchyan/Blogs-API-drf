...
class PostViewset(viewsets.ModelViewSet):
    ...
    def perform_create(self, serializer):
        logger.info('Creation of a new post assigning the author the current user!')
    ...
    def update(self, request, *args, **kwargs):
        ...
        if instance.status != 'NULL' and (request.user == instance.author or request.user.is_staff) \
            ...
            logger.debug('The post is successfully updated!')
    ...
    def destroy(self, request, *args, **kwargs):
        ...
        if instance.status != 'NULL' and (request.user == instance.author or request.user.is_staff) \
            ...
            logger.debug('The post is successfully deleted!')
...
class CategoryViewset(viewsets.ModelViewSet):
    logger.info('Called categories viewset!')
    permission_classes = [permissions.IsAuthenticated]
